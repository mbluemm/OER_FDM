...
export default defineConfig({
  ...
  themeConfig: {
    ...
    collapsed: true,
    items: [
      { text: '1. Forschungsdaten', link: '/lz/01_LE-Doz_Forschungsdaten.md' },
      { text: '2. Forschungsdatenmanagement', link: '/lz/02_LE-Doz_Forschungsdatenmanagement.md' },
      { text: '3. Datenlebenszyklus', link: '/lz/03_LE-Doz_Datenlebenszyklus.md' },
      { text: '4. FAIR-Prinzipien', link: '/lz/04_LE-Doz_FAIR-Prinzipien.md' },        
      { text: '5. Datendokumentation', link: '/lz/05_LE-Doz_Datendokumentation.md' },
      { text: '6. Metadaten', link: '/lz/06_LE-Doz_Metadaten.md' },
      { text: '7. Dateistruktur', link: '/lz/07_LE-Doz_Dateistruktur.md' },
      { text: '8. Daten speichern', link: '/lz/08_LE-Doz_Daten-Speichern.md' },
      { text: '9. Daten finden', link: '/lz/09_LE-Doz_Daten-Finden.md' },
      { text: '10. Recht', link: '/lz/10_LE-Doz_Recht.md' },
      { text: '11. Ethik', link: '/lz/11_LE-Doz_Ethik.md' },
      { text: '12. Arbeiten im Team', link: '/lz/12__LE-Doz_Arbeiten-im-Team.md' },
      ]
    },
    {
      ...
      items: [
        ...
        { text: '8. Daten speichern', link: '/texte/08_LE_Daten_Speichern.md' },
        { text: '9. Daten finden', link: '/texte/09_LE_Daten_Finden.md' },
